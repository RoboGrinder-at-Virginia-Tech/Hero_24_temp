...
general_odom_info_t trig_M6020_odom; //M2006拨弹电机里程计
/*
初始化里程计信息
*/
void odometer_init(void)
{
	memset(&trig_M6020_odom, 0, sizeof(general_odom_info_t));
	
	
	//初始化需要的具体信息
	trig_M6020_odom.motor_ptr = get_trigger_motor_measure_point();
...
//	trig_M2006_odom.total_ecd_count = (fp32)(trig_M2006_odom.motor_ptr->total_ecd - trig_M2006_odom.init_total_ecd + trig_M2006_odom.motor_ptr->delta_ecd);
	trig_M6020_odom.total_ecd_count = (fp32)(trig_M6020_odom.motor_ptr->total_ecd + trig_M6020_odom.motor_ptr->delta_ecd);
}

//Getter method
fp32 get_trig_modor_odom_count()
{
	return trig_M6020_odom.total_ecd_count;
}
