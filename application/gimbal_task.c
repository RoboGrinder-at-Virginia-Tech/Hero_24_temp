...
void gimbal_task(void const *pvParameters)
{
    ...
    while (1)
    {
        ...
        pitch_can_set_current = gimbal_control.gimbal_pitch_motor.given_current;
				...
				pitch_can_set_current_aid = (int16_t) ((-0.99f) * pitch_can_set_current); //助力电机
					...
					&& toe_is_error(TRIGGER_MOTOR_TOE)))
        {
            ...
            {
                CAN_cmd_gimbal(pitch_can_set_current, pitch_can_set_current_aid, shoot_can_set_current);
