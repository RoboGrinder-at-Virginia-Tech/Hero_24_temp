...
const uint16_t ui_dynamic_crt_sendFreq = 50; //500; //1000; //+50+; //1; //1000;
...
//				Line_Draw(&gAimVertL, "001", UI_Graph_ADD, 2, UI_Color_Orange, 1, 960+20, 540, 960+20, 0);
				Line_Draw(&gAimVertL, "001", UI_Graph_ADD, 2, UI_Color_Orange, 1, 960, 540, 960, 0);
				
				//2m - 不用 point zero - 修改为最靠底部的一个reference line
			//	Line_Draw(&gAimHorizL2m, "003", UI_Graph_ADD, 2, UI_Color_Yellow, 1, (960-50), (540-24), (960+50), (540-24));//50 很老
				...
				Line_Draw(&gAimHorizL2m, "003", UI_Graph_ADD, 2, UI_Color_Yellow, 1, (960-30), (540-248), (960+30), (540-248));
				//3m
				//Line_Draw(&gAimHorizL3m, "004", UI_Graph_ADD, 2, UI_Color_Yellow, 1, (960-15), (540-130), (960+55), (540-130));//length 70 20+ size of big armor plate 很老
...
//				Line_Draw(&gAimHorizL3m, "004", UI_Graph_ADD, 2, UI_Color_Yellow, 1, (960-14), (540-130), (960+14), (540-130)); //向左挪
				Line_Draw(&gAimHorizL3m, "004", UI_Graph_ADD, 2, UI_Color_Yellow, 1, (960-14), (540-25), (960+14), (540-25)); //
				
				//4m (540-150) "005"
				//Line_Draw(&gAimHorizL4m, "005", UI_Graph_ADD, 2, UI_Color_Yellow, 1, (960-2), (540-227), (960+42), (540-227));//length 44 17+ size of big armor plate 很老
...
//				Line_Draw(&gAimHorizL4m, "005", UI_Graph_ADD, 2, UI_Color_Yellow, 1, (960-9), (540-227), (960+9), (540-227));//length 44 17+ size of small armor plate
				Line_Draw(&gAimHorizL4m, "005", UI_Graph_ADD, 2, UI_Color_Yellow, 1, (960-9), (540-66), (960+9), (540-66));
				//5m (540-170) "006"
				//Line_Draw(&gAimHorizL5m, "006", UI_Graph_ADD, 2, UI_Color_Yellow, 1, (960+4), (540-320), (960+37), (540-320));//length 33  17+size of big armor plate 很老
...
//				Line_Draw(&gAimHorizL5m, "006", UI_Graph_ADD, 2, UI_Color_Yellow, 1, (960-6), (540-320), (960+7), (540-320));
				Line_Draw(&gAimHorizL5m, "006", UI_Graph_ADD, 2, UI_Color_Yellow, 1, (960-6), (540-148), (960+7), (540-148));
...
//				Line_Draw(&left2to3, "017", UI_Graph_ADD, 2, UI_Color_Yellow, 1, (960-31-20), (540-66), (960-15-20), (540-130) );
				Line_Draw(&left2to3, "017", UI_Graph_ADD, 2, UI_Color_Yellow, 1, (960-31-20), (540), (960-15-20), (540-25) );
//				Line_Draw(&left3to4, "018", UI_Graph_ADD, 2, UI_Color_Yellow, 1,(960-15-20), (540-130), (960-2-20), (540-227));
				Line_Draw(&left3to4, "018", UI_Graph_ADD, 2, UI_Color_Yellow, 1,(960-15-20), (540-25), (960-2-20), (540-66));
//				Line_Draw(&left4to5, "019", UI_Graph_ADD, 2, UI_Color_Yellow, 1, (960-2-20), (540-227), (960+4-20), (540-320));
				Line_Draw(&left4to5, "019", UI_Graph_ADD, 2, UI_Color_Yellow, 1, (960-2-20), (540-66), (960+4-20), (540-148));
...
//				Line_Draw(&right2to3, "021", UI_Graph_ADD, 2, UI_Color_Yellow, 1, (960+71-20), (540-66), (960+55-20), (540-130) );
				Line_Draw(&right2to3, "021", UI_Graph_ADD, 2, UI_Color_Yellow, 1, (960+71-20), (540), (960+55-20), (540-25) );
//				Line_Draw(&right3to4, "022", UI_Graph_ADD, 2, UI_Color_Yellow, 1, (960+55-20), (540-130), (960+42-20), (540-227));
				Line_Draw(&right3to4, "022", UI_Graph_ADD, 2, UI_Color_Yellow, 1, (960+55-20), (540-25), (960+42-20), (540-66));
//				Line_Draw(&right4to5, "023", UI_Graph_ADD, 2, UI_Color_Yellow, 1, (960+42-20), (540-227), (960+37-20), (540-320));
				Line_Draw(&right4to5, "023", UI_Graph_ADD, 2, UI_Color_Yellow, 1, (960+42-20), (540-66), (960+37-20), (540-148));
...
//				Char_ReFresh(strReferee);
				...
				UI_ReFresh(5, gAimHorizL2m, gAimHorizL3m, gAimHorizL4m, gAimHorizL5m, right4to5);
